...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f2027,50:203a43,100:2c5364&height=200&section=header&text=Evton%20Luís&fontSize=60&fontColor=ffffff&fontAlignY=38&desc=Full%20Stack%20em%20formação%20%7C%20Entusiasta%20de%20IA&descAlignY=58&descSize=18&animation=fadeIn" width="100%"/>
...
```python
evton = {
    "cargo":    "Full Stack em formação & Entusiasta de IA 🚀",
    "estuda":   ["Python", "Git/GitHub", "Front-end"],
    "pratica":  ["Pandas", "Streamlit", "Gemini API"],
    "foco":     "Unir análise de dados + interfaces modernas 🎯"
}
```

> 🌱 Em transição para a área de tecnologia — aprendendo, construindo e evoluindo todos os dias.
...
[![My Skills](https://skillicons.dev/icons?i=python,javascript,html,css,git,github,tailwind)](https://skillicons.dev)
